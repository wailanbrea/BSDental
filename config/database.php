...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'landlord' => [
            'driver' => env('LANDLORD_DB_DRIVER', env('DB_CONNECTION', 'sqlite')),
            'url' => env('LANDLORD_DB_URL'),
            'host' => env('LANDLORD_DB_HOST', env('DB_HOST', '127.0.0.1')),
            'port' => env('LANDLORD_DB_PORT', env('DB_PORT', '3306')),
            'database' => env('LANDLORD_DB_DATABASE', env('DB_CONNECTION') === 'sqlite' || env('LANDLORD_DB_DRIVER') === 'sqlite' ? database_path('landlord.sqlite') : 'bsdental_landlord'),
