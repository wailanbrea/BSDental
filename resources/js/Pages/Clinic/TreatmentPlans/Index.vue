...
const progress = (plan: Plan) => plan.items.length ? Math.round((plan.items.filter(item => item.status === 'completed').length / plan.items.length) * 100) : 0
</script>
